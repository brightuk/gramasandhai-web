    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <a href="<?= base_url('shop/').$shop_id ?>/shopBannerAdd" class="btn btn-primary btn-round ms-auto">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            ...
                                            <a href="<?= base_url() ?>shopbanner/hide/<?= $slide['id'] ?>"
                                                class="btn btn-link btn-primary btn-lg">
                                                <i
                                                    class="bi <?= $slide['status'] == '0' ? 'bi-toggle2-off text-danger' : 'bi-toggle-on text-success' ?> fs-4 "></i>
                                            </a>
                                            <!-- <a href="<?= base_url() ?>shopbanner/hide/<?= $slide['id'] ?>"
