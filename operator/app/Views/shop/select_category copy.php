        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-3">
                    ...
                    <form action="<?= base_url('categories/save-selection') ?>" method="POST" id="categoryForm">
                        <?= csrf_field() ?>
                                            ...
                                            <label class="form-check-label w-100 user-select-none"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="category-info flex-grow-1">
                                                        <h6 class="mb-0 fw-bold text-truncate" style="font-size: 0.9rem;"><?= $category['category_name'] ?></h6>
                                                        <small class="text-muted d-block text-truncate" style="font-size: 0.75rem;"><?= $category['category_subtitle'] ?></small>
                                                        <div class="mt-1">
                                                            <span class="badge bg-<?= $category['status'] == 1 ? 'success' : 'danger' ?>" style="font-size: 0.65rem;">
