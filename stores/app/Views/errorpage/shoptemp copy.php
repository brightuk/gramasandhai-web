...
<head>
    ...
    <title>Shop Temporarily Unavailable</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <!-- <div class="error-code">Error Code: STU</div> -->

        <p>We're sorry for the inconvenience. Our shop is currently undergoing maintenance to provide you with a better
        ...
        <div class="status-info">
            ...
            <ul>
                ...
                <li>Updating our inventory systems</li>
        ...
        <div class="actions">
            ...
            <a href="mailto:support@yourshop.com" class="btn btn-secondary">
                📧 Contact Support
            </a>
        </div>
    ...
    <script>
        ...
        <?= $burl ?>
        setTimeout(function () {
            // For PHP integration - add this at the top of the script
        ...
        setTimeout(() => {
            showNotification('Page will refresh automatically in 30 seconds');
        }, 2000);
