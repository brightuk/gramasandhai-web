                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 mb-3 product-item"
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1 d-flex flex-column">
                                ...
                                <?php if(!empty($variant['disc_price']) && $variant['disc_price'] > 0 ): ?> <div
                                    class="product_offer"><?= $variant['disc_type'] == 1? '-₹' : '' ?>
                                    <?= $variant['disc_price'] ?><?= $variant['disc_type'] == 2? '%' : '' ?> </div>
                                ...
                                <div class="mb-2">
                                    <select class="form-select-sm qty-select w-100 rounded-pill bg-light border-0 px-2"
                                        ...
                                        <option value="<?= $finalPrice ?>"
                                            ...
                                            <?= $index === 0 ? 'selected' : '' ?>>
                                            <?= esc($variant['measure']) ?> - ₹<?= number_format($finalPrice, 2) ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                    ...
                    <div
                        ...
                        <div class="desktop-card-body">
                            ...
                            <div class="mb-3 text-center">
                                ...
                                <select
                                    ...
                                    style="width: fit-content; min-width:120px; font-size:0.8rem;" id="variantSelect">
                                    <?php foreach ($productVariants as $index => $variant): ?>
                        ...
                        <div class="mt-auto d-flex align-items-center gap-2 ct-add addCart1">
                            <button class="btn btnadd add-to-cart-btn fw-semibold text-white" id="addCart1"
...
document.querySelectorAll('.add-to-cart-btn').forEach(button => {
    button.addEventListener('click', function() {
        ...
        // Optionally, pass variantId if present as a data attribute
        const variantId = selectedOption.dataset.variantId || null;

        addToCart(productId, productName, price, measure, image, variantId);
    });
});
</script>
