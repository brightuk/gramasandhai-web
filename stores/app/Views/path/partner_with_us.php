                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted">Access thousands of potential customers actively looking for local
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted">Increase your sales and visibility with our marketing support and
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted">Trust in our secure payment system and reliable customer support
                                    for your business.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    <div class="col-md-3">
                        <div class="text-center">
                            ...
                            <p class="text-muted small">Fill out the partnership application form with your business
                                details</p>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://golegalindia.com/fssai-registration" target="_blank"
                                            class="text-decoration-none small">Apply Here</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small mb-0">Goods and Services Tax Identification Number
                                        </p>
                                        <a href="https://www.inditab.com/gst/gst-registration-online" target="_blank"
                                            class="text-decoration-none small">Apply Here</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <div id="step1">
                            ...
                            <p class="text-muted mb-4">Enter your mobile number to begin your partnership journey with
                                Gramasandhai</p>
                            ...
                            <form id="phoneForm">
                                ...
                                <button type="button" class="btn btn-primary w-100 py-2 rounded-3"
                                    onclick="verifyPhone()">Continue to Application</button>
                            </form>
                        </div>
                        ...
                        <div id="step2" style="display: none;">
                            ...
                            <p class="text-muted mb-4">Fill in your business details to move forward with the
                            ...
                            <form id="businessForm">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="business_name" name="business_name"
                                            placeholder="Your business/restaurant name" required>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="business_type" name="business_type" required>
                                            ...
                                            <option value="<?= esc($category['id']) ?>">
                                                <?= esc($category['label_name']) ?></option>
                                            <?php endforeach; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="fssai_license_number"
                                            name="fssai_license_number"
                                            placeholder="Enter your 14-digit FSSAI License Number" pattern="^[0-9]{14}$"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="gstin_number" name="gstin_number"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="pancard" name="pancard"
                                            ...
                                            title="Enter a valid PAN Number (e.g., ABCDE1234F)" value="ABCDE1234F"
                                            required>
                                    </div>


                                    <div class="col-md-6 mb-3">
                                        <label for="app_login_pass" class="form-label fw-semibold">App Login
                                            Password</label>
                                        <input type="password" class="form-control" id="app_login_pass" name="password"
                                            placeholder="Enter your app login password" required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label fw-semibold">About Your Business</label>
                                    <textarea class="form-control" id="description" name="description" rows="4"
                                        placeholder="Tell us about your business, specialties, target customers, etc."></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-select" id="state" name="state" required>
                                            ...
                                            <option value="<?= esc($state['id']) ?>"><?= esc($state['state']) ?>
                                            </option>
                                            <?php endforeach; ?>
                                            <option value="other">Other</option>
                                        </select>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="pincode" name="pincode"
                                            maxlength="6" minlength="6" placeholder="Enter your pincode" required>
                                    </div>

                                </div>
                                <div class="mb-3">
                                    <label for="Business address" class="form-label fw-semibold">Business
                                        address</label>
                                    <textarea class="form-control" id="business_address" name="business_address"
                                        rows="4" placeholder="Enter your business address"></textarea>
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button" class="btn btn-primary flex-fill py-2 rounded-3"
                                        onclick="goToStep3()">
                        ...
                        <div id="step3" style="display: none;">
                            ...
                            <p class="text-muted mb-4">Please upload clear copies of the following documents for
                                verification</p>

                            <form action="<?= base_url('join/partner-with-us') ?>" method="post"
                                ...
                                <div class="mb-4">
                                    <div class="alert alert-info">
                                        ...
                                        <strong>File Requirements:</strong> PDF, JPG, or PNG files only. Maximum file
                                        size: 5MB per file.
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="document-upload-card">
                                            <label for="fssai_license_file" class="form-label fw-semibold">FSSAI License
                                            ...
                                            <input type="file" class="form-control d-none" id="fssai_license_file"
                                                name="fssai_license_file" accept=".pdf,.jpg,.jpeg,.png" required>
                                            <div class="form-text">Upload clear copy of your FSSAI license certificate
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="document-upload-card">
                                            <label for="gstin_certificate_file" class="form-label fw-semibold">GSTIN
                                            ...
                                            <input type="file" class="form-control d-none" id="gstin_certificate_file"
                                                name="gstin_certificate_file" accept=".pdf,.jpg,.jpeg,.png" required>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="document-upload-card">
                                            <label for="pan_card_file" class="form-label fw-semibold">PAN Card Copy
                                            ...
                                            <input type="file" class="form-control d-none" id="pan_card_file"
                                                name="pan_card_file" accept=".pdf,.jpg,.jpeg,.png" required>
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="document-upload-card">
                                            <label for="shopping_products_file" class="form-label fw-semibold">Shop
                                                Products</label>
                                            ...
                                            <input type="file" class="form-control d-none" id="shopping_products_file"
                                                name="shopping_products_file" accept=".pdf,.jpg,.jpeg,.png">
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="document-upload-card">
                                            <label for="bank_details_file" class="form-label fw-semibold">Bank Account
                                                Proof</label>
                                            ...
                                            <input type="file" class="form-control d-none" id="bank_details_file"
                                                name="bank_details_file" accept=".pdf,.jpg,.jpeg,.png">
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="document-upload-card">
                                            <label for="business_photos_file" class="form-label fw-semibold">Business
                                                Photos</label>
                                            <div class="file-upload-area" data-target="business_photos_file"
                                                data-multiple="true">
                                                <div class="file-upload-placeholder">
                                                    <i class="fas fa-cloud-upload-alt fa-2x text-muted mb-2"></i>
                                            ...
                                            <input type="file" class="form-control d-none" id="business_photos_file"
                                                name="business_photos_file[]" accept=".jpg,.jpeg,.png" multiple>
                                ...
                                <div class="form-check mb-4">
                                    ...
                                    <label class="form-check-label" for="terms_agreement">
                                        I agree to Gramasandhai's <a href="<?= base_url() ?>content/terms-of-service"
                                            class="text-decoration-none">Terms & Conditions</a> and <a
                                            href="<?= base_url() ?>content/privacy-policy"
                    ...
                    <div class="card border-0 bg-light">
                        <div class="card-body py-3">
                            ...
                            <div class="d-flex justify-content-center gap-3">
                                ...
                                <small><i class="fas fa-envelope text-primary me-1"></i>
                                    partners@gramasandhai.com</small>
                            </div>
                        </div>
                    </div>
                </div>
...
// Global variable for existing shops (populated from PHP)
const existingPhone = typeof window.existingPhone !== 'undefined' ? window.existingPhone : [];
...
function highlightRequiredField(fieldId) {
    const uploadArea = document.querySelector(`[data-target="${fieldId}"]`);
    if (!uploadArea) return;

    const card = uploadArea.closest('.document-upload-card');
    if (!card) return;
...
function verifyPhone() {
    ...
    if (phoneExists) {
        alert(
            'This mobile number is already registered with an active shop. Please use a different number or contact support.'
            );
        mobileInput.focus();
        return;
    }

    // Check for pending shop data via AJAX
...
function checkPendingShop(mobile) {
    ...
    // Note: Replace with your actual base_url
            ...
            if (data.success) {
                ...
                if (data.pending === 'yes' && data.shop) {
                    setTimeout(() => {
                        ...
                        showNotification(
                            'We found your previous application. Please review and update if needed.',
                            'info');
                    }, 100);
                }
...
function fillFormWithPendingData(shop) {
    ...
    if (fields.fssai_license_number && shop.fssai_license_number) fields.fssai_license_number.value = shop
    ...
    // Handle cascading dropdowns with promises for better control
    handleCascadingDropdowns(fields, shop);
}

function handleCascadingDropdowns(fields, shop) {
    if (!fields.state || !shop.state_id) return;
    ...
    if (shop.city_id) {
        const cityInterval = setInterval(() => {
            if (fields.city && fields.city.options.length > 1) {
                ...
                if (shop.area_id) {
                    const areaInterval = setInterval(() => {
                        if (fields.area && fields.area.options.length > 1) {
                            clearInterval(areaInterval);
                            fields.area.value = shop.area_id;
                            fields.area.dispatchEvent(new Event('change', {
                                bubbles: true
                            }));
                        }
                    }, 100);

                    // Safety timeout for area
                    setTimeout(() => clearInterval(areaInterval), 3000);
                }
            }
        }, 100);

        // Safety timeout for city
        setTimeout(() => clearInterval(cityInterval), 3000);
    }
}
...
function goToStep3() {
    // Validate business form first
    const businessForm = document.getElementById('businessForm');
    if (!businessForm || !businessForm.checkValidity()) {
        if (businessForm) businessForm.reportValidity();
        return;
    }

    // Copy all form data to hidden fields in step 3
    const fieldMappings = {
        'verified_mobile': 'final_mobile',
        'name': 'final_name',
        'email': 'final_email',
        'business_name': 'final_business_name',
        'business_type': 'final_business_type',
        'description': 'final_description',
        'fssai_license_number': 'final_fssai_license_number',
        'gstin_number': 'final_gstin_number',
        'pancard': 'final_pancard',
        'state': 'final_state',
        'city': 'final_city',
        'area': 'final_area',
        'app_login_pass': 'final_app_login_pass',
        'business_address': 'final_business_address',
        'pincode': 'final_pincode'
    };

    Object.keys(fieldMappings).forEach(sourceId => {
        const sourceElement = document.getElementById(sourceId);
        const targetElement = document.getElementById(fieldMappings[sourceId]);
...
function goBackToStep2() {
    ...
    // Scroll to business form smoothly
    document.getElementById('step2').scrollIntoView({
        behavior: 'smooth'
    });
}
