...
<div class="container my-4 my-md-5" style="max-width: 700px;">
    ...
    <div id="orderContent">
     ...
     <div class="card mb-3 mb-md-4">
            ...
            <div class="card-body" id="deliveryToggleIcon" style="display: none;">
                <div class="payment-option" onclick="selectPaymentMethod('cod')">
                    <input type="radio" name="paymentMethod" id="codRadio" value="cod">
                    <label for="codRadio" class="fw-bold">Cash on Delivery (COD)</label>
                    <p class="mb-0 small text-muted">Pay in cash when your order is delivered</p>
...
<script>
    ...
    function updateOrderButtonState() {
        const cart = getCart(); // Assuming getCart() fetches cart items
        const paymentMethod = document.querySelector('input[name="paymentMethod"]:checked');
        const transactionId = document.getElementById('transactionId');
        const submitBtn = document.getElementById('submitOrderBtn');

        let isValid = (cart && cart.length > 0) && paymentMethod;
    ...
    // Sample getCart() function to be replaced with actual cart data fetching logic
    function getCart() {
        // Example: return cart items from localStorage or any other source
        const cartData = localStorage.getItem('cart');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Add change listeners to radios to update UI on manual change
        document.querySelectorAll('input[name="paymentMethod"]').forEach(input => {
            input.addEventListener('change', () => selectPaymentMethod(input.value));
        });

        // Disable submit button initially
        updateOrderButtonState();

        // Remove invalid class on transaction ID input change
    ...
    function showSelectedAddress(address) {
        ...
        //         ${address.state} - ${address.pincode}, ${address.country}<br>
        //         Phone: ${address.phone_no}
        //     </div>
        // `;
    }
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                if (data.status === "success") {
                    ...
                    // Optional: alert or handle failure case
    ...
    document.getElementById('submitOrderBtn').addEventListener('click', function () {
        ...
        fetch("<?= base_url(); ?>edit/getaddress/" + selectedAddressId, {
            ...
            .then(data => {
                ...
                // const selectedAddress = data.data;
                ...
                document.getElementById('orderForm').action = "<?= base_url($shop_url_name . '/' . 'orderplaced/') ?>" +
                    userId;
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Initialize both dropdowns as closed by default
        // document.getElementById('addressCardBody').style.display = 'none';
